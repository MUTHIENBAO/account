<div class="primary-block">
    <div class="main-content">
        ...
        <ul class="tabs-content">
            <li class="active"><a href="#acc_manager&act=changepass1_info" rel="ajax"">Dùng thông tin tài khoản</a></li>
            <li><a href="#acc_manager&act=changepass1" rel="ajax">Dùng dịch vụ SMS</a></li>
        </ul>
    </div>
</div>
...
<div class="primary-block out-top-20">
    ...
    <form id="changepass1" name="changepass1" method="post" action="index.php?mod=acc_manager&act=changepass1_info">
        ...
        <div class="form-3">
            ...
            <div class="form-row">
                <div class="form-col-1">Xác minh Mật khẩu Web mới</div>
            ...
            <div class="form-row">
                ...
                <div class="form-col-2">
                    <input class="form-style" name="email" type="text" id="email" size="17" maxlength="50" value="<?php echo $_POST['email']; ?>" onkeyup="check_email(this.value,'msg_'+this.name)"></div>
