<div class="primary-block">
    <div class="main-content">
        ...
        <ul class="tabs-content">
            <li class="active"><a href="#acc_manager&act=changepassgame_info" rel="ajax">Dùng thông tin tài khoản</a></li>
            <li><a href="#acc_manager&act=changepassgame" rel="ajax">Dùng dịch vụ SMS</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="head-block">
        ...
        <form id="changepassgame" name="changepassgame" method="post" action="index.php?mod=acc_manager&act=changepassgame_info">
            ...
            <div class="form-3">
                ...
                <div class="form-row">
                    <div class="form-col-1">Xác minh Mật khẩu Game mới</font></div>
                ...
                <div class="form-row">
                    <div class="form-col-1">Mật khẩu Web cấp 2</font></div>
                ...
                <div class="form-row">
                    <div class="form-col-1">Địa chỉ E-Mail</font></div>
                    <div class="form-col-2"><input class="form-style" name="email" type="text" id="email" size="14" maxlength="50" onfocus="focus_chuso(this.value,'msg_'+this.name);" onkeyup="check_chuso_4_20(this.value,'msg_'+this.name)" /></div>
                    <div class="form-col-3"><label id="msg_email" class="msg"></label></div>
                </div>
                <div class="form-row">
                    <div class="form-col-1">Câu hỏi bí mật</font></div>
                ...
                <div class="form-row">
                    <div class="form-col-1">Trả lời bí mật</font></div>
                    <div class="form-col-2"><input class="form-style" name="ans" type="text" id="ans" size="17" maxlength="50" value="<?php echo $_POST['ans']; ?>" onfocus="focus_chuso(this.value,'msg_'+this.name);" onkeyup="check_chuso_4_10(this.value,'msg_'+this.name)" /></div>
