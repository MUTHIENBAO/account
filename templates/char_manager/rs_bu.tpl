<div class="primary-block">
    <div class="main-content">
        <h1 class="title-content">Reset Bù</h1>
...
<div class="priority-block out-top-20">
    ...
    <div class="in-20">
        <ul class="noted in-left-10">
            <li><strong>Reset Bù</strong> : sử dụng khi người chơi hôm trước bị bận việc, không Reset hết được số lần Reset trong ngày.</li>
            <li><strong>Reset Bù</strong> : Reset nốt số lần Reset hôm trước chưa Reset.</li>
            <li><strong>Reset Bù</strong> : Giống hệt như Reset VIP</li>
            <li>Phí Reset Bù = Phí Reset VIP + Phí phạt.</li>
            <li>Chỉ Reset Bù khi đã Reset hết số lần Reset của ngày hôm nay.</li>
            <li><strong>Reset Bù không được tính vào Đua TOP</strong>.</li>
...
<div class="primary-block out-top-20">
    ...
    <div class="in-20">
        ...
        <div class="form-2" id="rs_content">
            ...
            <div class="form-row">
                <div class="form-col-1"><span>Reset hôm qua</span></div>
                <div class="form-col-2">
                    <?php echo "$notifice_rs_yesterday"; ?>
                </div>
                <div class="form-col-3">&nbsp;</div>
            </div>
            <div class="form-row">
                <div class="form-col-1"><span>Reset bù</span></div>
                <div class="form-col-2">
                    <?php echo "$notifier_rs_bu"; ?>
                </div>
                <div class="form-col-3">&nbsp;</div>
            </div>
            <div class="form-row">
                <div class="form-col-1"><span>Reset / Relife tối đa</span></div>
                <div class="form-col-2">
                    <?php echo "$notifier_rs_max"; ?>
                </div>
                <div class="form-col-3"><?php echo "$notifier_rs_max_end"; ?></div>
            </div>
            <div class="form-row">
            ...
            <div class="form-submit">
                    ...
                    <button class="btn btn-green btn-block btn-lg" type="button" name="Submit" id="btn_rs_bu" <?php if($accept=='0') { echo 'disabled="disabled"'; } ?> >Thực hiện Reset Bù</button>
