...
<div class="wrap-fluid <?php echo $_left_menu; ?>">
    <div class="topuser">
        ...
        <?php } else { ?>
            <span class="welcome">Hệ thống web tài khoản <?php echo $slide; ?></span>
        <?php } ?>
    </div>
    <div class="col-left">
    ...
    <div class="col-right">
            ...
            <div class="main-block">
                <div class="main-left">
                    <div class="in-right-30">
                        <div class="notify">
                            <marquee behavior="scroll" direction="left">Hệ thống quản lý tài khoản <strong>MU THIÊN BẢO &reg;Beta 2018</strong>.</marquee>
                        </div>
                ...
                <div class="main-right">
                    <div class="guide-use">
                        <a href="<?php echo $forumlink;?>" title="Fanpage"><span>Fanpage</span></a>						
                    </div>
        ...
        <div class="footer">
            <p class="copyright">
               Copyright &copy; MU THIEN BAO. All rights reserved.</br>
                <span>Phiên bản web MU được phát triển bởi BP 2018</span>
            </p>
        </div>
    </div>
</div>
