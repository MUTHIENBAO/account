		  ...
		  function setView() {
            ...
            if(width < 980) {
			  if(index) {
                ...
                $("#BlockLeft").css({"margin-right": "0px"});
                $(".home-right").hide();				  
			  }
			  else {
                $(".home-left").hide();
                $(".home-left").css({"width": "70%"});
                $("#BlockLeft").css({"margin-right": "35px"});
                $(".home-right").show();
			  }
			}
			else {
...
<div id="homesl2" style="position:absolute;display:block;background:url(images/loading.gif) no-repeat center center;top:0px;left:0px;width:100%;height:100%;">
...
<div id="sls2" u="slides" style="cursor:move;position:absolute;left:0px;top:0px;height:310px;overflow:hidden;">
  ...
  <script type="text/javascript" src="templates/js-d/slide.js?v=<? echo $_SERVER['REQUEST_TIME']; ?>"></script>
        ...
        <div class="in-10 list-events-block">
          ...
          <ul class="list-events">
            ...
            <?php
                ...
                if($khuyenmai_phantram > 0) {
                  ...
                  echo "<li><a href='javascript:void(0);'>". _langarr($lang_home_eventcard_week, $lang_arr) ."</a></li>";
							...
							if($giftcode_nt_use > 0 && (strtotime($event_napthegc_end) >= time() - 5*24*60*60)) {
								...
								$lang_arr = array("$giftcode_nt_name", date('d/m', strtotime($event_napthegc_begin)), date('d/m', strtotime($event_napthegc_end)));

								echo "<li><a href='javascript:void(0);'>". _langarr($lang_home_event_napthegiftcode, $lang_arr) ."</a></li>";
              ...
              }														if($Use_luckyspin == 1) {                echo "<li><a href='javascript:void(0);'>". $lang_home_event_spin ."</a></li>";              }
      ...
      <div class="login-block in-10">
        ...
        <form class="form-login" action="" id="login" method="post">
          ...
          <div class="out-10">
            ...
            <p class="lostpass"><a rel="ajax" href="#receive_pass1">Bạn đã quên mật khẩu ?</a></p>
          ...
          <div class="out-10 register-line-block">
            ...
            <a rel="ajax" href="#register" class="btn btn-orange btn-block btn-lg" onClick="viewToggle()">Đăng ký tài khoản</a>
