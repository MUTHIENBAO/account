<div class="primary-block">
    <div class="main-content">
        <h1 class="title-content">Quản lý Hỗ Trợ </h1>
    </div>
</div>
...
<form id="check" name="check" method="post" action="index.php?mod=support&act=adm_readsupport&id=<?php echo $subid; ?>">
  ...
  Theo dõi
  <input class="Accept" type="submit" name="Submit" value="Thực hiện" />
</form>
</div>
				...
				<div class="ContainerIndent PadBot10">
					...
					<?php if($support_status !=9) { ?>							
                                <div class="Container100 MarTop5">
									...
									<input class="Accept" type="submit" name="Submit" value="Trả lời Hỗ trợ" />
                                    </div>
                                </div>
					<?php } ?>			
                        </div>
