...
include('config/config_epwing3.php');
		...
		if( $sendsv === false ) { $notice = "Tốc độ xử lý của bạn quá nhanh, vui lòng chờ vài giây rồi tiếp tục thực hiện."; }
			...
			elseif($reponse == "login_other") {
				...
				if ($info[0] == 'OK') {
					...
					$_SESSION['nv_LenhBaiWing3'] = $_SESSION['nv_LenhBaiWing3'] - $lenhbai_choise;
				}
				else $notice = $reponse;
			}
		}
...
$lenhbaiepdo = $_SESSION['nv_LenhBaiWing3'];
...
$page_template = "templates/maychao/epwing3.tpl";
?>