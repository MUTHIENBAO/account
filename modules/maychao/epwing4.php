...
include('config/config_epwing4.php');
		...
		if( $sendsv === false ) { $notice = "Tốc độ xử lý của bạn quá nhanh, vui lòng chờ vài giây rồi tiếp tục thực hiện."; }
			...
			elseif($reponse == "login_other") {
				...
				if ($info[0] == 'OK') {
					...
					$_SESSION['nv_LenhBaiWing4'] = $_SESSION['nv_LenhBaiWing4'] - $lenhbai_choise;
				}
				else $notice = $reponse;
			}
		}
...
$chenhlech_gcoin = $_SESSION['acc_gcoin'] - $GcoinEpThanhCong;
$lenhbaiepdo = $_SESSION['nv_LenhBaiWing4'];
...
if ($chenhlech_gcoin < 0) { $notice_gcoin = "$font_thieu_begin Thiếu ". ABS($chenhlech_gcoin) ." Gcent $font_thieu_end"; } else { $notice_gcoin = "$font_du_begin Đủ Gcent xoay wing $font_du_end"; }

$accept = 1;
if ( $_SESSION['nv_online'] == 1 || $_SESSION['nv_doinv'] == 0 || $chenhlech_gcoin < 0 ) { $accept = 0; }	

$page_template = "templates/maychao/epwing4.tpl";
?>