...
include('config/config_epwing5.php');
		...
		if( $sendsv === false ) { $notice = "Tốc độ xử lý của bạn quá nhanh, vui lòng chờ vài giây rồi tiếp tục thực hiện."; }
			...
			elseif($reponse == "login_other") {
				...
				if ($info[0] == 'OK') {
					...
					$_SESSION['nv_LenhBaiWing5'] = $_SESSION['nv_LenhBaiWing5'] - $lenhbai_choise;
				}
				else $notice = $reponse;
			}
		}
...
$lenhbaiepdo = $_SESSION['nv_LenhBaiWing5'];
...
$page_template = "templates/maychao/epwing5.tpl";
?>